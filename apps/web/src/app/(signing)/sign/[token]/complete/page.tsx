      ...
      >
        ...
        >
          <div className="flex flex-col items-center gap-x-4">
            <CheckCircle2 color="#39BF78" className="text-destructive mb-2 h-10 w-10" />
            ...
            {match({ status: document.status, deletedAt: document.deletedAt })
              .with({ deletedAt: null, status: DocumentStatus.PENDING }, () => (
              ...
              .with({ deletedAt: P.when((deletedAtDate) => !!deletedAtDate) }, () => (
          ...
          {match({ status: document.status, deletedAt: document.deletedAt })
            .with({ status: DocumentStatus.COMPLETED }, () => (
              <p className="text-muted-foreground mt-2.5 max-w-[60ch] text-center text-sm">
                <Trans>
                  Everyone has signed! You will receive an Email copy of the signed document.
                </Trans>
              </p>
            ))
            .with({ status: DocumentStatus.PENDING }, () => (
              <p className="text-muted-foreground mt-2.5 max-w-[60ch] text-center text-sm">
                <Trans>
                  Everyone has signed! You will receive an Email copy of the signed document.
                </Trans>
            ...
            .with({ deletedAt: null }, () => (
              <p className="text-muted-foreground/60 mt-2.5 max-w-[60ch] text-center text-sm md:text-base">
                <Trans>

    ...
    >
      ...
      {!field.inserted && (
        ...
        >
          <span className="flex items-center justify-center gap-x-1">
            <Type
              aria-hidden="true"
              className="h-[clamp(0.625rem,20cqw,0.925rem)] w-[clamp(0.625rem,20cqw,0.925rem)]"
            />
      ...
      {field.inserted && (
        <div className="flex h-full w-full items-center">
          <p
            className={cn(
              'dark:text-background/80 w-full overflow-hidden text-ellipsis whitespace-nowrap text-[clamp(0.425rem,25cqw,0.825rem)] duration-200',
              {
        ...
        <DialogContent>
          ...
          <div>
            <Textarea
              ...
              value={localText}
              aria-label={parsedFieldMeta?.label}

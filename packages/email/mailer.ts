import type { SentMessageInfo, Transport, Transporter } from 'nodemailer';
...
class DisabledTransport implements Transport<SentMessageInfo> {
...
const getTransport = (): Transporter => {
  ...
  if (transport === 'disabled') {
    ...
    return createTransport(DisabledTransport.makeTransport());
  }

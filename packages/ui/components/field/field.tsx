...
const getCardClassNames = (
  ...
  const insertedClasses =
    'bg-primary/20 border-primary hover:border-secondary focus-within:border-white ring-primary/20 ring-offset-primary/20 ring-2 ring-offset-2 dark:shadow-none';
  const nonRequiredClasses =
    'border-yellow-300 shadow-none ring-2 ring-yellow-100 ring-offset-2 ring-offset-yellow-100 dark:border-2 focus-within:border-black';
  const validatingClasses = 'border-orange-300 ring-1 ring-orange-300 focus-within:border-black';
  const requiredClasses =
    'border-red-500 shadow-none ring-2 ring-red-200 ring-offset-2 ring-offset-red-200 hover:text-red-500 focus-within:border-black';
  const requiredCheckboxRadioClasses = 'border-dashed border-red-500 focus-within:border-black';

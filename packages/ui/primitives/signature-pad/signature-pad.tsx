  ...
  return (
    ...
    >
      ...
      <div className="text-foreground absolute left-3 top-3 filter">
        <button
          className="focus-visible:ring-ring ring-offset-background text-muted-foreground/60 hover:text-muted-foreground flex cursor-pointer flex-row gap-2 rounded-full p-2 text-[0.688rem] focus-visible:outline-none focus-visible:ring-2"
      ...
      <div className="absolute bottom-3 right-3 flex gap-2">
        <button
          type="button"
          className="focus-visible:ring-ring ring-offset-background hover:text-muted-foreground rounded-full p-0 text-[0.688rem] focus-visible:outline-none focus-visible:ring-2"
